...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card mb-4">
                    <h5 class="card-header">Centre D'Appels Page</h5>
                    <div class="card-body">
                        <form action="{{ route('centreDappelsStore') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="pt-3 pb-3">
                                ...
                                <input type="file" id="file" class="form-control" id="video" name="video" />
                            ...
                            <div class="pt-3 pb-3">
                                <label for="image" class="form-label pb-3">Image <span
                                        class="badge bg-label-danger">Size: 1920 * 734 px</span></label>
